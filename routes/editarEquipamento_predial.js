...
router.get('/:id', async (req, res) => {
    ...
    try {
        const equipamentoEncontrado = await equipamento_predial.findByPk(equipamentoId);
        ...
        res.render('editarEquipamento_predial', { equipamento: equipamentoEncontrado.toJSON() });
    } catch (error) {
...
router.post('/:id', async (req, res) => {
    ...
    try {
        const equipamentoEncontrado = await equipamento_predial.findByPk(equipamentoId); // Correção aqui
        ...
        res.redirect('/tabelaEquipamento_predial'); // Redireciona para a lista de equipamentos
    } catch (error) {
        console.error(error);
