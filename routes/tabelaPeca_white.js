...
const { Peca_white } = require('../model/peca_white.model'); // Keeping the import statement unchanged
...
router.get('/', async (req, res) => {
    try {
        ...
        const pecas = await Peca_white.findAll({ where: whereClause });

        res.render('tabelaPeca_white', {
