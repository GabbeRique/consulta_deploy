...
router.get('/', (req, res) => {
    res.render('login_white'); // Renderiza o formulário de login
});
...
router.post('/', async (req, res) => {
    ...
    try {
        ...
        const login_white = await Login_white.findOne({ where: { nome } });
        ...
        res.redirect('/index_adm_white'); // Mude para onde quiser redirecionar após login
    } catch (error) {
        console.error(error);
