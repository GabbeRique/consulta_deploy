...
router.get('/', (req, res) => {
    res.render('login_br11'); // Renderiza o formulário de login
});
...
router.post('/', async (req, res) => {
    ...
    try {
        ...
        const login_white = await login_br11.findOne({ where: { nome } });
        ...
        res.redirect('/index_adm_br11'); // Mude para onde quiser redirecionar após login
    } catch (error) {
        console.error(error);
