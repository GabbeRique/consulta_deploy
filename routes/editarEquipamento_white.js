...
const { EquipamentoWhite } = require('../model/equipamento_white.model'); // Importando corretamente
...
router.get('/:id', async (req, res) => {
    ...
    try {
        const equipamentoEncontrado = await EquipamentoWhite.findByPk(equipamentoId);
        ...
        res.render('editarEquipamento_white', { equipamento: equipamentoEncontrado.toJSON() });
    } catch (error) {
...
router.post('/:id', async (req, res) => {
    ...
    try {
        const equipamentoEncontrado = await EquipamentoWhite.findByPk(equipamentoId); // Correção aqui
        ...
        res.redirect('/tabelaEquipamento_white'); // Redireciona para a lista de equipamentos
    } catch (error) {
        console.error(error);
